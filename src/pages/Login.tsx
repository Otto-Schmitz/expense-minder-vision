      ...
      <div className="flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold">{t("nav.signIn")}</h2>
            <p className="text-gray-600 mt-2">{t("login.signInToAccount")}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 animate-slide-in">
            ...
            <Button type="submit" className="w-full h-12" disabled={loading}>
              {loading ? t("login.signingIn") : t("nav.signIn")}
            </Button>
      ...
      <div className="hidden lg:block relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-12">
          <div className="w-full max-w-md text-center">
            <h3 className="text-2xl font-bold mb-4">{t("login.sidebarTitle")}</h3>
